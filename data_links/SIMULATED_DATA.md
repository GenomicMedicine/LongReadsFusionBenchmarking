...
### Option 1: Quark Drive (Recommended for Mainland China)

Download the simulated dataset via Quark Drive for high-speed access within China.

* **Link:** [https://pan.quark.cn/s/ab9b97e62598](https://pan.quark.cn/s/ab9b97e62598)
* **Instructions:** 1. Open the link and save the `sim_data_upload` folder to your Quark account.
    2. Use the Quark Desktop client for stable, high-speed batch downloading.
    3. Once downloaded, extract the files using the command below:
