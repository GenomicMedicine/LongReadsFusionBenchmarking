...
# refCDSfa="/data2/reference/IFDlong/refData/hg38/CDS_all.fa" #"$codeBase/refData/$ghc/CDS_all.fa"
# outisoformfa="/data2/reference/IFDlong/refData/hg38/isoformAll_ref.fa" #"$codeBase/refData/$ghc/isoformAll_ref.fa"
# outAA="/data2/reference/IFDlong/refData/hg38/isoformAA_Ref.txt" #"$codeBase/refData/$ghc/isoformAA_Ref.txt"
# ncores=30
