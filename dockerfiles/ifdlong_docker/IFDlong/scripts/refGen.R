...
# refGTF="/data2/reference/IFDlong/refData/hg38/genes.gtf" #"$codeBase/refData/$ghc/genes.gtf"
# outEXON="/data2/reference/IFDlong/refData/hg38/allexon_NO.bed" #"$codeBase/refData/$ghc/allexon_NO.bed"
# outTol="/data2/reference/IFDlong/refData/hg38/gene_range_tol500.bed"
# outCDS="/data2/reference/IFDlong/refData/hg38/CDS_all.bed"
...
gtf_bed=gtf_cds[,c('chr', 'start','end', 'Name', 'score', 'strand')]
